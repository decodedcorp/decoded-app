  ...
  return (
    <>
      <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-40">
        <div
          className={`relative flex items-center justify-center bg-[#EAFD66] rounded-full shadow-xl text-black cursor-pointer transition-all duration-300 ease-in-out ${
        ...
        >
          ...
          {isFabMenuOpen && (
            <div className="absolute inset-0 flex items-center justify-around px-2 transition-opacity duration-300 delay-100 opacity-100">
              ...
              <button
                type="button"
                className="p-2 rounded-full hover:bg-[#EAFD66]/80 focus:outline-none focus:bg-[#EAFD66]/80"
