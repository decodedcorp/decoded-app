  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 py-3 flex items-center justify-between relative">
        {/* Left: Logo */}
        <div className="text-2xl font-bold text-[#EAFD66] tracking-tight">
          decoded
        </div>
        ...
        >
          <form onSubmit={handleSearchSubmit} className="relative">
            ...
            <input
              id="search"
              name="search"
              className="block w-full pl-10 pr-3 py-2 border border-[#EAFD66] rounded-md leading-5 bg-black/30 text-white placeholder-neutral-400 focus:outline-none focus:bg-black/40 focus:ring-1 focus:ring-[#EAFD66] focus:border-[#EAFD66] sm:text-sm"
              placeholder="Search"
              type="search"
              value={searchQuery}
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="p-2 rounded-md text-neutral-300 hover:text-white hover:bg-black/20 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#EAFD66]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
