...
description: Feature spec에서 TypeScript 인터페이스 자동 생성. "generate types", "data model", "create interface" 요청 시 자동 적용.
...
기존 `specs/shared/data-models.md` 패턴을 준수합니다.
...
```
> specs/discovery/spec.md에서 필요한 TypeScript 타입 생성해줘
> Post 엔티티에 대한 인터페이스 만들어줘
> API 응답에 맞는 타입 정의 생성해줘
```
