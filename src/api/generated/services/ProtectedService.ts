...
export class ProtectedService {
     ...
     * @throws ApiError
     */
    public static getAgreementsUserUserDocIdAgreementsGet(
        userDocId: string,
    ): CancelablePromise<Response> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/user/{user_doc_id}/agreements',
            path: {
                'user_doc_id': userDocId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static updateSettingsUserUserDocIdUpdateSettingsPatch(
        userDocId: string,
        ...
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/user/{user_doc_id}/update-settings',
            path: {
                'user_doc_id': userDocId,
            },
            query: {
     ...
     * Update Sui Address
     * @param userDocId The id of the user
     * @param suiAddress The sui address of the user
     * @param session
     * @returns Response Successful Response
     * @throws ApiError
     */
    public static updateSuiAddressUserUserDocIdAddressSuiAddressPatch(
        userDocId: string,
        suiAddress: string,
        session?: any,
    ): CancelablePromise<Response> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/user/{user_doc_id}/address/{sui_address}',
            path: {
                'user_doc_id': userDocId,
