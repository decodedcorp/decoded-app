...
export const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  const { login, loginWithGoogle, googleOAuthMutation } = useAuth();
  const isGoogleLoginLoading = googleOAuthMutation.isPending;
  ...
  const handleEmailLoginError = (error: string) => {
          ...
          <div className="text-center space-y-6">
            ...
            {showEmailLogin ? (
              ...
              <div className="space-y-4">
                <LoginForm onSuccess={handleEmailLoginSuccess} onError={handleEmailLoginError} />
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
