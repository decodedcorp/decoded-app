  ...
  if (comments.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-xl font-semibold text-white mb-2">{t.comments.noComments()}</h3>
        <p className="text-zinc-400 mb-6">{t.comments.noCommentsDescription()}</p>
        <p className="text-sm text-zinc-500">{t.comments.comingSoon()}</p>
      </div>
    );
  }
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  {comment.is_edited && <span className="text-xs text-zinc-500">(edited)</span>}
                </div>

                {/* Comment Text */}
                <p className="text-white mb-3 whitespace-pre-wrap">{comment.text}</p>
