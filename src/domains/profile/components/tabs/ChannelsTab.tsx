  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-xl font-semibold text-white mb-2">Failed to load channels</h3>
  ...
  if (channels.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-zinc-400 mb-6">Create your first channel to start sharing content.</p>
        <button
        ...
        {channels.map((channel) => (
          ...
          >
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-zinc-400">Contents</span>
