    ...
    <div className={`space-y-4 ${className}`}>
      ...
      {showMore && hasMoreItems && !showAll && (
        <div className="text-center pt-4">
          <button
            ...
            className="text-[#eafd66] hover:text-[#eafd66]/80 font-medium transition-colors duration-200"
          >
            Show More
          </button>
        </div>
      ...
      <div className="text-center pt-6">
        <p className="text-zinc-500 text-sm">
          The content provided above has been generated by an artificial intelligence. The information may contain errors or omissions.
        </p>
      </div>
    </div>
  );
