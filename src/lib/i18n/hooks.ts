...
export const useProfileTranslation = () => {
  ...
  return {
    ...
    skills: {
      ...
      count: (count: number) => t('skills.count', { count }),
      createNew: () => t('skills.createNew'),
      noSkills: () => t('skills.noSkills'),
      noSkillsDescription: () => t('skills.noSkillsDescription'),
      failedToLoad: () => t('skills.failedToLoad'),
      failedToLoadDescription: () => t('skills.failedToLoadDescription'),
      edit: () => t('skills.edit'),
      delete: () => t('skills.delete'),
      createTitle: () => t('skills.createTitle'),
      editTitle: () => t('skills.editTitle'),
      titleLabel: () => t('skills.titleLabel'),
      titlePlaceholder: () => t('skills.titlePlaceholder'),
      titleHelper: () => t('skills.titleHelper'),
      promptLabel: () => t('skills.promptLabel'),
      promptPlaceholder: () => t('skills.promptPlaceholder'),
      promptHelper: () => t('skills.promptHelper'),
      save: () => t('skills.save'),
      create: () => t('skills.create'),
      cancel: () => t('skills.cancel'),
      saving: () => t('skills.saving'),
      createSuccess: () => t('skills.createSuccess'),
      updateSuccess: () => t('skills.updateSuccess'),
      deleteSuccess: () => t('skills.deleteSuccess'),
      saveError: () => t('skills.saveError'),
      deleteError: () => t('skills.deleteError'),
      deleteConfirmMessage: () => t('skills.deleteConfirmMessage'),
      validation: {
        titleRequired: () => t('skills.validation.titleRequired'),
        titleMinLength: () => t('skills.validation.titleMinLength'),
        titleMaxLength: () => t('skills.validation.titleMaxLength'),
        titleInvalidFormat: () => t('skills.validation.titleInvalidFormat'),
        promptRequired: () => t('skills.validation.promptRequired'),
        promptMinLength: () => t('skills.validation.promptMinLength'),
        promptMaxLength: () => t('skills.validation.promptMaxLength'),
      },
    },
  };
};
