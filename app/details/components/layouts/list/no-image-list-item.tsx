import { NoImageListItemProps } from './no-image/types';
  ...
  return (
    <div className="flex w-full gap-3">
      ...
      <div className="flex flex-col justify-center flex-1 min-w-0">
        ...
        <button className="w-full h-8 bg-white/10 hover:bg-white/15 transition-colors rounded flex items-center justify-center gap-2">
