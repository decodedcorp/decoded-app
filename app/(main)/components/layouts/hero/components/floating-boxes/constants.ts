...
export const BOX_POSITION_SETS: BoxPosition[] = [
  ...
  {
    LEFT_TOP: { top: 20, left: 15 },
    LEFT_BOTTOM: { top: 48, left: 22 },
    RIGHT_TOP: { top: 28, right: 15 },
  },
  // Set 2 - 왼쪽 1개(큰 박스), 오른쪽 2개
  {
    LEFT_TOP: { top: 28, left: 15 },
    RIGHT_TOP: { top: 18, right: 18 },
    RIGHT_BOTTOM: { top: 45, right: 22 },
  },
]; 