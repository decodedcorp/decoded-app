  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <p className="text-sm text-gray-600 mb-4">
        This page demonstrates Supabase connection and type safety.
        Data is fetched using the query layer (not direct from() calls).
      </p>
      ...
      <div className="mb-8 p-6 border-2 border-gray-200 rounded">
        ...
        <p className="text-sm text-gray-600 mb-4">
          This section uses Server Component with fetchLatestPostsServer.
