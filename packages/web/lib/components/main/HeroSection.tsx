...
export function HeroSection({ data = defaultHeroData }: HeroSectionProps) {
  return (
    <section className="relative w-full aspect-[16/9] md:aspect-[21/9] overflow-hidden bg-gray-900">
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-12 lg:p-16">
        ...
        >
          {/* Artist Name */}
          <h2 className="text-4xl md:text-6xl lg:text-8xl font-bold text-white tracking-tight mb-4">
            {data.artistName}
          </h2>
