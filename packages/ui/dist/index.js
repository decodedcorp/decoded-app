...
var Avatar = ({
  ...
  const [imageError, setImageError] = import_react3.default.useState(false);
  const [imageLoaded, setImageLoaded] = import_react3.default.useState(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        src && !imageError && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "img",
          {
            src,
        ...
        showFallback && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-full h-full bg-gray-200 rounded-full flex items-center justify-center text-gray-600 font-medium", children: fallbackText })
      ]
    }
  );
};
...
var spinnerVariants = (0, import_class_variance_authority.cva)(
  ...
  "inline-flex items-center justify-center gap-2 rounded-md font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        ...
        primary: "bg-surface text-primary hover:bg-primary hover:text-primary-on shadow-sm hover:shadow-md",
        ...
        "comments-floating": "bg-black/80 text-white border border-primary/30 hover:bg-black/90 hover:border-primary/50 shadow-2xl hover:shadow-[0_8px_32px_rgba(234,253,102,0.15)] backdrop-blur-md hover:backdrop-blur-lg transition-all duration-300"
      },
      size: {
        sm: "h-8 px-3 text-sm",
  ...
  ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "button",
      {
        ...
        ...props,
        children: [
          loading && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Spinner, { size: "sm", variant: "white", "aria-label": "\uBC84\uD2BC \uB85C\uB529 \uC911" }),
          !loading && icon && iconPosition === "left" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon, { name: icon, className: "h-4 w-4", "aria-hidden": "true" }),
          children,
          !loading && icon && iconPosition === "right" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon, { name: icon, className: "h-4 w-4", "aria-hidden": "true" })
        ]
      }
    );
  }
...
var Dialog = ({ children, ...props }) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(DialogPrimitive.Root, { ...props, children });
var DialogTrigger = DialogPrimitive.Trigger;
var DialogContent = (0, import_react6.forwardRef)(({ className, variant, hideCloseButton = false, children, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(DialogPortal, { children: [
  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(DialogPrimitive.Overlay, { className: "fixed inset-0 z-overlay bg-black/50 backdrop-blur-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" }),
      ...
      children: [
        ...
        !hideCloseButton && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          DialogPrimitive.Close,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon, { name: "x", className: "h-4 w-4" })
          }
        )
      ]
    }
...
var DialogHeader = ({ className, ...props }) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: cn("flex flex-col space-y-1.5 text-center sm:text-left", className), ...props });
var DialogTitle = (0, import_react6.forwardRef)(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
...
var DialogDescription = (0, import_react6.forwardRef)(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
...
var DialogFooter = ({ className, ...props }) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
  "div",
  {
