...
echo "🚀 Starting development deployment to remote server..."
...
tar -czf decoded-app-dev-deploy.tar.gz -C $DEPLOY_DIR .

# Upload to remote server
echo "📤 Uploading to remote server..."
scp -P $REMOTE_PORT decoded-app-dev-deploy.tar.gz $REMOTE_USER@$REMOTE_HOST:/tmp/
...
tar -xzf /tmp/decoded-app-dev-deploy.tar.gz
rm /tmp/decoded-app-dev-deploy.tar.gz
...
rm -rf $DEPLOY_DIR
rm decoded-app-dev-deploy.tar.gz
