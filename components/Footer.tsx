      ...
      <div className="container mx-auto py-4 sm:py-8 lg:py-12 px-3 sm:px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-6 sm:mb-8">
          ...
          <div className="space-y-2 col-span-2 md:col-span-1">
            <h2 className={cn(pretendardMedium.className, "text-[#EAFD66] text-base sm:text-lg lg:text-xl")}>
              DECODED
            </h2>
          ...
          <div className="space-y-2">
            <h3 className={cn(pretendardMedium.className, "text-white text-sm sm:text-base")}>
          ...
          <div className="md:hidden">
            ...
            {isLegalOpen && (
              <div className="space-y-2 py-2">
                <p className="text-xs">{t.footer.legal.businessInfo.address}</p>
