...
export const mockPicks: PickInfo[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        affilateUrl:
          'https://www.tiffany.com/jewelry/rings/tiffany-titan-by-pharrell-williams-five-row-ring-GRP12633/',
        brand: {
          logoUrl:
    ...
    items: [
      {
        ...
        affilateUrl:
          'https://stockx.com/mihara-yasuhiro-peterson-og-sole-canvas-low-black',
        brand: {
          logoUrl:
      ...
      },
      {
        ...
        affilateUrl:
          'https://www.mytheresa.com/kr/en/women/coperni-wide-leg-denim-cargo-pants-blue-p00862439',
        brand: {
          logoUrl:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        affilateUrl:
          'https://thegreatalfred.com/product/detail.html?product_no=66&cate_no=48&display_group=1',
        brand: {
          logoUrl:
...
export const mockSpotlight: SpotlightInfo = {
  images: [
    ...
    },
    {
      ...
      imageUrl:
        'https://firebasestorage.googleapis.com/v0/b/tagged-d87d8.appspot.com/o/images%2Fjennie_airport_ck_gentle_monster_maison_marais_chanel?alt=media&token=380eb6fe-6c28-41a8-a6a2-e2c72aad33cb',
    },
    {
      id: 'fec109ec3cd354a9f28f9898df8e03563528850f71c0394b3dda6f8dc015a702',
      imageUrl:
        'https://firebasestorage.googleapis.com/v0/b/tagged-d87d8.appspot.com/o/images%2Fjennie_chanel_jacquemus?alt=media&token=5e0a2683-3683-4761-924c-47bcd404eef9',
    },
  ],
  title: '제니 x 젠틀몬스터 스타일',
  description:
    '제니가 젠틀몬스터의 오리지널 패션을 선보였습니다. 젠틀몬스터의 패션은 심플하면서도 고급스러운 분위기를 자아내며 많은 팬들의 주목을 받았다.',
  artist: '제니',
  profileImgUrl:
    'https://firebasestorage.googleapis.com/v0/b/tagged-d87d8.appspot.com/o/artists%2Fjennie.jpeg?alt=media&token=2599768b-38b9-4c26-b04f-604b0a4166a5',
};
...
export const mockTrendingNow: TrendingNowInfo[] = [
  {
    name: 'streetwear',
    imageUrl:
      'https://firebasestorage.googleapis.com/v0/b/tagged-d87d8.appspot.com/o/images%2Fstreetwear.jpg?alt=media&token=5df9a578-921a-4783-9f9d-1bf022f18d8a',
  },
  {
    name: 'sneakers',
    imageUrl:
      'https://firebasestorage.googleapis.com/v0/b/tagged-d87d8.appspot.com/o/images%2Fsneakers.jpg?alt=media&token=5df9a578-921a-4783-9f9d-1bf022f18d8a',
  },
  {
    name: 'newjeans',
    imageUrl:
      'https://firebasestorage.googleapis.com/v0/b/tagged-d87d8.appspot.com/o/images%2Ffashion.jpg?alt=media&token=5df9a578-921a-4783-9f9d-1bf022f18d8a',
  },
  {
    name: 'blackpink',
    imageUrl:
      'https://firebasestorage.googleapis.com/v0/b/tagged-d87d8.appspot.com/o/images%2Fstyle.jpg?alt=media&token=5df9a578-921a-4783-9f9d-1bf022f18d8a',
  },
  {
    name: 'kpop',
    imageUrl:
      'https://firebasestorage.googleapis.com/v0/b/tagged-d87d8.appspot.com/o/images%2Fkpop.jpg?alt=media&token=5df9a578-921a-4783-9f9d-1bf022f18d8a',
  },
  {
    name: 'prada',
    imageUrl:
